        ...
        if MediaType == "IMAGE":
            ...
            if DetectObject:
                if (CntFin[Target] >= 1):
                    ...
                    yolov3.yolov3(pb_file=YOLOv3_pb, image_path=outputTargetFile, recordpath=TextPath, option=gpu_option)
                    CntFin = [0, 0, 0, 0, 0, 0]
            ...
            if DetectObject:
                if (CntFin[Target] >= Time):
                    ...
                    threading.Thread(target=yolov3.yolov3, args=(YOLOv3_pb, outputTargetFile, TextPath, gpu_option)).start()
                    CntFin = [0, 0, 0, 0, 0, 0]
